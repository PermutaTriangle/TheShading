...
# printf "(1,2) Lemma 7\n"
# python classify.py results/sl/surprising_coincidence_01_SL.txt -lemma7 1 > results/lemma7/surprising_coincidence_01_SL_Lemma7.txt
...
# python classify.py results/sl/surprising_coincidence_012_SL.txt -lemma7 1 > results/lemma7/surprising_coincidence_012_SL_Lemma7.txt
...
# python classify.py results/sl/surprising_coincidence_021_SL.txt -lemma7 1 > results/lemma7/surprising_coincidence_021_SL_Lemma7.txt
