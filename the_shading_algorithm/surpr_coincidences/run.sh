...
# 
# printf "(1,2) Lemma 2\n"
# python classify.py results/surprising_coincidence_01_SL.txt -lemma2 > results/surprising_coincidence_01_SL_Lemma2.txt
# printf "(1,2,3) Lemma 2\n"
# python classify.py results/surprising_coincidence_012_SL.txt -lemma2 > results/surprising_coincidence_012_SL_Lemma2.txt
# printf "(1,3,2) Lemma 2\n"
# python classify.py results/surprising_coincidence_021_SL.txt -lemma2 > results/surprising_coincidence_021_SL_Lemma2.txt
# 
...
# 
# printf "(1,2) Lemma 5\n"
# python classify.py results/surprising_coincidence_01_SL.txt -lemma5 > results/surprising_coincidence_01_SL_Lemma5.txt
